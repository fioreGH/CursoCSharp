...
namespace CursoCSharp.Api
{
    class ExemploTimeSpan
    {
        public static void Executar()
        {
            ...
            Console.WriteLine(intervalo.Add(TimeSpan.FromMinutes(8))); //cria um novo, não mexe no original
            Console.WriteLine(intervalo.Subtract(TimeSpan.FromMinutes(8))); //cria um novo, não mexe no original
            ...
            Console.WriteLine("Parse: " + TimeSpan.Parse("10:02:03").TotalMilliseconds);
